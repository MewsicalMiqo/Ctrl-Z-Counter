...
namespace Ctrl_Z_Counter
{
    ...
    class GlobalKeyboardHook : IDisposable
    {
        ...
        public static Keys[] ModifierKeys = new Keys[] {
            Keys.LShiftKey,
            Keys.LControlKey,
            Keys.LMenu,
            Keys.RShiftKey,
        ...
        public bool IsModifierDown(Keys modifier) => currentModifiers.Contains(GetGenericModifier(modifier));

        public void AddModifier(Keys modifier)
        {
            Keys genericMod = GetGenericModifier(modifier);
            currentModifiers.Add(genericMod);
        }

        public void RemoveModifier(Keys modifier)
        {
            Keys genericMod = GetGenericModifier(modifier);
            currentModifiers.Remove(genericMod);
        }

        private List<Keys> currentModifiers = new List<Keys>();

        private Keys GetGenericModifier(Keys modifier)
        {
            switch (modifier)
            {
                case Keys.LShiftKey:
